...
public class TransactionManagerStreamsApplication {
...
//
//                    builder
//                            .from(builder.add(transactionIDsSource))
//                            .toInlet(assignTransactionIDs.in1());
//
//                    builder
//                            .from(assignTransactionIDs.out())
//                            .via(builder.add(Flow.of(Transaction.class).divertTo(rejectedTransactionsSink,trans->{
//                                Account account = accounts.get(trans.getAccountNumber());
