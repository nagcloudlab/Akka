package com.example.ex3.streaming;
...
import com.example.ex3.blockchain.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Flow<Block, HashResult, NotUsed> miningProcess = ActorFlow.ask(actorSystem,Duration.ofSeconds(30),(block,self)->{
            return new ManagerBehavior.MineBlockCommand(block,self,5);
        });
